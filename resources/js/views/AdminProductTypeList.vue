    ...
    <layout name="Dashboard">
        <div class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <section class="product-types">
                <div class="mb-1">
                    <router-link :to="{ name: 'pt.create' }" class="btn btn-success">Add New Product Type</router-link>
                </div>
...
<script>
    ...
    const getPTs = (page, callback) => {
        const params = { page };

        axios
            .get('/api/product-types', { params })
            .then(response => {
