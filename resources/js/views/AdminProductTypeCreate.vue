    ...
    export default {
        ...
        methods: {
            ...
            onSubmit($event) {
                ...
                api.create(this.pt)
                    .then((response) => {
                        this.$router.push({ name: 'pt.edit', params: { id: response.data.data.id } });
                    })
                    .catch((e) => {
                        this.message = e.response.data.message || `There was an issue creating the new Product Type.`;
                    })
